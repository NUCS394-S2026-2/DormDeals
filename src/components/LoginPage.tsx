    ...
    <div className="login-container">
      <div className="login-card">
        <div className="login-header">
          <h1 className="login-title">DormDeals</h1>
          <p className="login-subtitle">
            Buy and sell furniture with your dorm community
          </p>
        </div>

        {error && <div className="login-error">{error}</div>}

        <button onClick={handleGoogleSignIn} disabled={loading} className="login-button">
